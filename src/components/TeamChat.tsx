    ...
    const timer = setTimeout(() => {
      ...
      if (el) {
        ...
        const hlTimer = setTimeout(() => {
          setHighlightedMessageId((cur) => (cur === focusMessageId ? null : cur))
        }, 3000)
                      ...
                      >
                        ...
                        >
                          {toolPayload ? (
                            ...
                            m.text && (() => {
                              const isMentioned = !mine && !!currentMember && (
                                m.text.includes(`@${currentMember.name}`) ||
                                m.text.includes("@전체") ||
                              ...
                              return (
                                ...
                                >
                                  ...
                                  <ChatMessageText text={m.text} mine={mine} myName={currentMember?.name} />
                                </div>
                              )
                            })()
                          )}
