...
const STORAGE = 'https://abc.supabase.co/storage/v1/object/public/board-attachments/u/a.png';
...
await check('게시글 첨부: 우리 Storage board-attachments 주소만 허용', async () => {
  ...
  for (const bad of ['https://evil.com/a.exe', 'javascript:alert(1)', 'http://abc.supabase.co/storage/v1/object/public/board-attachments/a', 'https://abc.supabase.co/storage/v1/object/public/workspace-files/a']) {
